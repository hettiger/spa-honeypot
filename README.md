...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/spa-honeypot.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/spa-honeypot)
...
```php
$honeypot = new Hettiger\Honeypot();
echo $honeypot->echoPhrase('Hello, Hettiger!');
```
