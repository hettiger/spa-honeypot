...
namespace Hettiger\Honeypot\Tests\Features\FormProtection;
...
function attempt(?string $token = null, ?string $value = null): TestResponse
{
...
it('blocks request with filled honeypot field', function () {
    ...
    assertDidBlock(attempt($validToken, 'value-fake'), false);
});
